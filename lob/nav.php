                ...
                <ul class="list-unstyled mb-0 d-flex align-items-center order-1 order-lg-2 nav-sidelinks">
                    ...
                    <li class="d-lg-none">
                        <span class="nav-link text-body d-flex align-items-center cursor-pointer" data-bs-toggle="collapse"
                              data-bs-target="#mobileNavDropdown" aria-controls="mobileNavDropdown" aria-expanded="false"
                    ...
                    if (isset($_SESSION['id'])) {
                        ?>
                        <li style="color:white !important" class="ms-1 d-inline-block position-relative dropdown-cart">
                        Hi, <?= $_SESSION['fname'] ?> |
                        </li>
                       
                            
                        <li class="ms-1 d-inline-block position-relative dropdown-cart"><a style="color:white !important" class="dropdown-item" href="profile.php">Profile | </a></li>
                            <li class="ms-1 d-inline-block position-relative dropdown-cart"><a  style="color:white !important" class="dropdown-item" href="myorder.php">Order</a></li>
